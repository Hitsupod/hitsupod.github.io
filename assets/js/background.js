var RENDERER = {
	...
	setParameters : function(){
		this.$window = $(window);
		this.$javabox = $('#jsi-hex-container');
		this.$canvas = $('<canvas />');
		this.context = this.$canvas.appendTo(this.$javabox).get(0).getContext('2d');
		this.hexagons = [];
		this.resizeIds = [];
	},
	setup : function(){
		...
		this.width = this.$javabox.width();
		this.height = this.$javabox.height();
